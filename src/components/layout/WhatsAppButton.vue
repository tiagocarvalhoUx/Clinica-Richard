  ...
  >
    ...
    >
      <div
        ...
        class="absolute bottom-[4.75rem] right-0 w-[350px] max-w-[calc(100vw-1.25rem)] origin-bottom-right overflow-hidden rounded-2xl bg-white shadow-elevated ring-1 ring-slate-200"
      >
        <header class="bg-[#075E54] text-white px-4 py-3 flex items-center gap-3">
          <div class="relative h-11 w-11 rounded-full bg-white/15 grid place-items-center">
            <svg class="h-6 w-6 translate-y-px" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
              <path
    ...
    <button
      type="button"
      class="relative grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-elevated transition hover:-translate-y-0.5 hover:bg-[#1FBA59] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/40 active:scale-95 sm:h-16 sm:w-16"
    ...
    >
      ...
      >
        <svg
          v-if="!aberto"
          key="wa"
          class="relative h-7 w-7 translate-y-px sm:h-8 sm:w-8"
          viewBox="0 0 32 32"
          fill="currentColor"
          aria-hidden="true"
        >
